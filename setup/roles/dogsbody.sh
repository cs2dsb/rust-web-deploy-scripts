...
# Set any variables (list in setup/variables.sh) in ./variables to
# override them. USER_ACCOUNT and USER_PUB_KEY reccomended as a start
source ./variables
...
"../setup/hostname.sh" "dogsbody-`date "+%Y%m%d%H"`"
